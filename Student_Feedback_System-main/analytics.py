...
def write_to_csv_departments(time,teachingscore,teaching,courseContentscore,courseContent,
                 ...
                 libraryFacilities,extraCurricularscore,extraCurricular,emailid,dept,name):
    ...
    with open('dataset/database.csv', "a", newline='') as f:
        ...
        dict = {'Timestamp': time, 'teachingscore': teachingscore, 'teaching': teaching,
                ...
                'extracurricular': extraCurricular,'name': name ,'dept':dept,'emaiid': emailid}
...
def get_counts():
    ...
    df2 = df.groupby('dept').count()[['name']]
    dfc = df2['name'][0]
    dfi = df2['name'][1]
    dfe = df2['name'][2]
    ...
    li = [teaching_positive_count,teaching_negative_count,teaching_neutral_count,
          ...
          extracurricular_positive_count,extracurricular_negative_count,extracurricular_neutral_count,dfc,dfi,dfe]
